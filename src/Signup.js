        ...
        {isSignedIn() ? <Navigate to="/"/> :             
            <div className="Signup">
                ...
                <form className="Signup-form">
                    <input type="text" className="Signup-text" placeholder="first name" value={formData.firstName} name="firstName" onChange={handleChange} autoComplete="email"></input>
                    <input type="text" className="Signup-text" placeholder="last name" value={formData.lastName} name="lastName" onChange={handleChange} autoComplete="email"></input>
